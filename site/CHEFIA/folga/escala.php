                ...
                <thead>
                    ...
                    <?php
                        ...
                        foreach ($resultado as $lin){ 
                            ...
                            echo"<tr>";
                            echo"<th style='background-color:#808080;'>{$lin['idusuario']}</th><th style='background-color:#C0C0C0;'><a href = 'cadastrar_folga&idusuario={$lin['idusuario']}'><span class='text-capitalize'>{$lin['nome']}&nbsp;{$lin['sobrenome']}</span></a></th>";
                            ...
                            for($i= 1; $i <= $mesDias; $i++){
                                ...
                                if($resposta){   
                                    ...
                                    if($diafolga == $i){
                                        ...
                                        if((int)$mesinformado < ((int)$mesAtual - 1) && (int)$ano_informado <= (int)$anoAtual){   
                                            switch ($tipofolga){
                                                case"sap":
                                            ...
                                            switch ($tipofolga){
                                                case"sap":
                                                    echo '<td style="background-color:#98FB98;"><a href="acao&idusuario='.$lin['idusuario'].'&idfolga='.$linfolga['idfolga'].'">'.strtoupper($tipofolga).'</a></td>';
                                                    break;
                                                case"abo":
                                                    echo '<td style="background-color:#F0E68C;"><a href="acao&idusuario='.$lin['idusuario'].'&idfolga='.$linfolga['idfolga'].'">'.strtoupper($tipofolga).'</a></td>';
                                                    break;
                                                case"con":
                                                    echo '<td style="background-color:#ADD8E6;"><a href="acao&idusuario='.$lin['idusuario'].'&idfolga='.$linfolga['idfolga'].'">'.strtoupper($tipofolga).'</a></td>';
                                                    break;
                                                case"doa":
                                                    echo '<td style="background-color:#FFB6C1;"><a href="acao&idusuario='.$lin['idusuario'].'&idfolga='.$linfolga['idfolga'].'">'.strtoupper($tipofolga).'</a></td>';
                                                    break;
                                                case"ele":
                                                    echo '<td style="background-color:#C0C0C0;"><a href="acao&idusuario='.$lin['idusuario'].'&idfolga='.$linfolga['idfolga'].'">'.strtoupper($tipofolga).'</a></td>';
                                                    break;
                                            }  
                                        }
                                    } else {
